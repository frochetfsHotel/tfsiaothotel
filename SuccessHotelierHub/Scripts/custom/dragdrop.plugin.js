...
(function ($) {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 27, selected: 0, showHeader: true, plain: false, fit: false, border: true, justified: false, narrow: false, pill: false, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_3aa) {
...
(function ($) {
    ...
    function _3e6(_3e7, _3e8, _3e9) {
        ...
        function _3ed(dir) {
            ...
            p.panel($.extend({}, $.fn.layout.paneldefaults, {
                cls: ("layout-expand layout-expand-" + dir), title: "&nbsp;", titleDirection: _3eb.titleDirection, iconCls: (_3eb.hideCollapsedContent ? null : _3eb.iconCls), closed: true, minWidth: 0, minHeight: 0, doSize: false, region: _3eb.region, collapsedSize: _3eb.collapsedSize, noheader: (!isns && _3eb.hideExpandTool), tools: ((isns && _3eb.hideExpandTool) ? null : [{
    ...
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, {
        region: null, split: false, collapsedSize: 28, expandMode: "float", hideExpandTool: false, hideCollapsedContent: true, collapsedContent: function (_41f) {
            var p = $(this);
...
(function ($) {
    ...
    $.fn.menu.defaults = {
        zIndex: 110000, left: 0, top: 0, alignTo: null, align: "left", minWidth: 120, itemHeight: 22, duration: 100, hideOnUnhover: true, inline: false, fit: false, noline: false, events: { mouseenter: _43a, mouseleave: _43d, mouseover: _441, mouseout: _444, click: _446 }, position: function (_476, left, top) {
            return { left: left, top: top };
        }, onShow: function () {
        }, onHide: function () {
...
(function ($) {
    ...
    $.fn.switchbutton.defaults = {
        handleWidth: "auto", width: 60, height: 26, checked: false, disabled: false, readonly: false, reversed: false, onText: "ON", offText: "OFF", handleText: "", value: "on", onChange: function (_4bf) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        passwordChar: "%u25CF", checkInterval: 200, lastDelay: 500, revealed: false, showEye: true, inputEvents: { focus: _560, blur: _564 }, val: function (_56d) {
...
(function ($) {
    ...
    function _697(_698) {
        ...
        if (opts.pagination) {
            ...
            _69f.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_6a0, _6a1) {
    ...
    function _6ae(_6af) {
        ...
        _6b4.each(function () {
            $(this).resizable({
                handles: _6b5, edge: opts.resizeEdge, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _6b0.resizing = true;
...
(function ($) {
    ...
    function _8b2(_8b3) {
        ...
        $(_8b3).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_8b5, row) {
...
(function ($) {
    function _903(_904) {
        ...
        if (opts.pagination) {
            ...
            _910.pagination({
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_911, _912) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, animate: false, singleSelect: true, view: _9a8, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _91e(true), mouseout: _91e(false), click: _920 }), loader: function (_9e6, _9e7, _9e8) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
...
(function ($) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _9f8, textFormatter: function (_a14, row) {
            return _a14;
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _a29, keydown: _a2d, paste: _a2d, drop: _a2d }, panelEvents: {
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupPosition: "static", groupField: null, groupFormatter: function (_ab6) {
            return _ab6;
        }, mode: "local", method: "post", url: null, data: null, queryParams: {}, showItemIcon: false, limitToList: false, unselectedValues: [], mappingRows: [], view: _ab1, keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
...
(function ($) {
    ...
    $.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
        hasDownArrow: false, multiple: true, reversed: true, selectOnNavigation: false, tipOptions: $.extend({}, $.fn.textbox.defaults.tipOptions, { showDelay: 200 }), val: function (_b8e) {
...
(function ($) {
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_c1e) {
            return _c1e;
        }, converter: {
...
//            	return $dst.hasClass("droppable") || $dst.parents(".droppable").length > 0;
//            },
